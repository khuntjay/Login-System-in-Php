...
$sql ="SELECT * from nieosoft where email ='$email' AND password ='$password'";
...
<?php
  ...
  if($login){
    ...
    <strong> not sucess !</strong> you are not login now.
    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
      <span aria-hidden="true">&times;</span>
    </button>
  </div>';
...
<form  method="post" action="login.php"> 
  ...
  <div class="container  col-sm-6">
    <div class="form-group row ">
      <label for="inputEmail3" class="col-md-7 col-form-label" required>Email</label>
      <div class="col-sm-10">
